...
public class RunSudoku implements Runnable {
    public void run() {
        ...
        reset.addActionListener(e -> board.restart());
        control_panel.add(reset);

        // Instructions
        String instructionBody = """
                In Sudoku, you are given a 9x9 grid. Each number 1-9 must appear once
                and only once in any row, column, or inner 3x3 box that it is in. Solve 
                the puzzle with less than 5 mistakes to win!
                Click on a cell, use your keyboard keys to enter a number, and press
                Enter to see if you've gotten the right answer.""";
